  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start">
        <div className="w-full md:w-1/3 mb-8 md:mb-0">
          ...
          <p className="text-gray-400 mt-4">
            ...
            nulla delectus ipsam, ipsum cupiditate totam debitis laudantium vel
            doloribus sint?
          </p>
        </div>
        ...
        <div className="w-full md:w-1/3 ">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="
                p-2 rounded bg-gray-800 text-gray-400 border border-gray-700 focus:outline-none w-full md:w-auto "
            />
      ...
      <div className="border-t border-gray-700 py-4 mt-10 text-center text-gray-500">
        Copyright 2025 &copy; Haneen Sweedan. All Right Reserved.
      </div>
    </div>
  );
};
